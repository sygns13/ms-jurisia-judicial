...
public class TipoDocumento {
    ...
    @NotNull( message = "{TipoDocumento.idInstancia.notnull}")
    @Size(min = 1, max = 10, message = "{TipoDocumento.idInstancia.size}")
    @Column(name = "idInstancia", nullable = true, length = 10)
